...
<body>
    ...
    <div class="main">
    <h1>Bourre Listeux (BL) :</h1>
        <div class="bl">
            <iframe id="gsheet" src="https://docs.google.com/spreadsheets/d/1jmJicp3qJHkP_b7TANMe6oTjQMB4TvzjkQMhNQ_nOtk/htmlembed/sheet?gid=0"></iframe>
            <div class="ajout_bl">
                <h1>Ajouter un BL</h1>
...
function sendform() {
    ...
    xhttp.open("POST", "https://script.google.com/macros/s/AKfycbw-LmgpcGjBaq8SGmvFS6FODDqSBT8MIR2zYFeHS2QxRRvRvw2q/exec", false);
