...
<body>
    ...
    <div class="main">
    <h1>Bouffe Listeux (BL) :</h1>
        <div class="bl">
            <iframe id="gsheet" src="https://docs.google.com/spreadsheets/d/136VutZ7GPkAJtTxuwuOOil44AvStpEihNiKdBmuxLPc/htmlembed/sheet?gid=0"></iframe>
            <div class="ajout_bl">
                <h1>Ajouter un BL</h1>
...
function sendform() {
    ...
    xhttp.open("POST", "https://script.google.com/macros/s/AKfycbzoIxeIX-Jt5cmHVjUK0_aVAjaz5DWWsLMvqIhT4qzq9ZmnnbaX/exec", false);
